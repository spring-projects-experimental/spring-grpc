...
public class ShadedNettyChannelCredentialsProvider implements ChannelCredentialsProvider {

	private final GrpcClientProperties channels;

	private final SslBundles bundles;

	public ShadedNettyChannelCredentialsProvider(SslBundles bundles, GrpcClientProperties channels) {
